...
public class Main {
    public static void main (String[] args){
        ...
        //3.1
        Nominator nominator1 = new Nominator("3.1nominator",6,200,50);
        ...
        //3.2
        Nominator nominator2 = new Nominator("3.2nominator",6,20,100);
        ...
        //3.3
        Nominator nominator3 = new Nominator("3.3nominator",6,200,100);
        ...
        //3.4
        Nominator nominator4 = new Nominator("3.4nominator",5,200,50);
